...
!function (e, t) {
    ...
    var I, D, U, j, G, K, q, V, Y, Q, W, J, X, Z, $, r = (ScrollSmoother.register = function register(e) {
        return D || (I = e || t(), s() && window.document && (U = window, j = document, G = j.documentElement, K = j.body), I && (q = I.utils.toArray, V = I.utils.clamp, W = I.parseEase("expo"), Z = I.core.context || function () {
        }, Y = I.core.globals().ScrollTrigger, I.core.globals("ScrollSmoother", ScrollSmoother), K && Y && ($ = I.delayedCall(.2, function () {
    ...
    function ScrollSmoother(t) {
        ...
        function Oa() {
            G = j.documentElement, K = j.body, Da(), requestAnimationFrame(Da), b && (Y.getAll().forEach(function (e) {
                ...
                var t = e._startClamp || e.start,
                    r = e.autoSpeed ? Math.min(v(), e.end) : t + Math.abs((e.end - t) / e.ratio), n = r - e.end;
                if ((r -= n / 2) < (t -= n / 2)) {
                    var o = t;
                    t = r, r = o
                }
        ...
        function Ta(r, e, t, n, o) {
            ...
            function gc(e) {
                if (a) {
                    ...
                    var t = function _autoDistance(e, t) {
                        var r, n, o = e.parentNode || G, i = e.getBoundingClientRect(), s = o.getBoundingClientRect(),
            ...
            var i, s, a, l, c, f, u = Sa("speed", e, n, r), h = Sa("lag", t, n, r), d = I.getProperty(r, "y"),
                g = r._gsap, p = [], m = [], y = 0;
        ...
        var n, S, e, i, b, s, a, l, c, f, r, u, h, d, g, p, m = t.smoothTouch, w = t.onUpdate, T = t.onStop,
            _ = t.smooth, C = t.onFocusIn, P = t.normalizeScroll, x = t.wholePixels, R = this,
            E = t.effectsPrefix || "", k = Y.getScrollFunc(U),
            H = 1 === Y.isTouch ? !0 === m ? .8 : parseFloat(m) || 0 : 0 === _ || !1 === _ ? 0 : parseFloat(_) || .8,
            A = H && +t.speed || 1, N = 0, F = 0, M = 1, z = J(0), B = {y: 0},
        ...
        Pa(), Y.addEventListener("killAll", Pa), I.delayedCall(.5, function () {
            ...
            var n, o = (e = q(e)[0]).style.cssText, i = Y.create({trigger: e, start: t || "top top"});
        ...
        O.forEach(function (e) {
            ...
            debounce: !0,
            content: !H && n
        } : P)), Y.config(t), "scrollBehavior" in U.getComputedStyle(K) && I.set([K, G], {scrollBehavior: "auto"}), U.addEventListener("focusin", Ka), a = setInterval(Ba, 250), "loading" === j.readyState || requestAnimationFrame(function () {
            return Y.refresh()
        })
    }
